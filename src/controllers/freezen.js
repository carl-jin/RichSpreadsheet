  ...
  : {
      ...
      cancelFreezenVertical: function (sheetIndex) {
        ...
        if (currentSheet.frozen != null && isvertical) {
          server.saveParam("all", sheetIndex, currentSheet.frozen, {
            k: "frozen",
          });
        }
      },
      ...
      saveFreezen: function (
        ...
        //  更新这个值到 frozen 里面
        if (currentSheet.freezen && currentSheet.frozen?.range) {
          if (currentSheet.freezen?.vertical?.freezenverticaldata) {
            currentSheet.frozen.range.column_focus =
              currentSheet.freezen.vertical.freezenverticaldata[1] - 1;
          }
      ...
      scrollFreezen: function () {
        ...
        if (column_focus == Store.luckysheet_select_save[0]["column"][0]) {
          ...
          column_focus == Store.luckysheet_select_save[0]["column"][1]
        ) {
    ...
    getAdaptOffsetLeftInfo : function(x){
        ...
        if (
          ...
          for (let s = 0; s < Store.luckysheet_select_save.length; s++) {
            ...
            if (s == Store.luckysheet_select_save.length - 1) {
              let rf = obj.row_focus == null ? r1 : obj.row_focus;
              let cf =
                obj.column_focus == null ? obj.column[0] : obj.column_focus;
      ...
      scrollAdaptOfpostil: function () {
        ...
        if (
          ...
          $("#luckysheet-postil-showBoxs .luckysheet-postil-show").each(
            function (i, e) {
              let id = $(e).attr("id");
              ...
              let postil_left =
                postil["left"] == null ? toX + 18 : postil["left"];
              ...
              if (r >= _this.freezenhorizontaldata[1]) {
                if (postil_top + postil_height < freezenTop) {
                  $(e)
                    ...
                    .css("top", postil_top + offTop);
                  $(e)
                    .show()
                    .find(".arrowCanvas")
                    .css("top", size[1] + offTop);
                } else {
                  if (postil_top < freezenTop + offTop) {
                    if (postil_top + postil_height <= freezenTop + offTop) {
                      ...
                      $(e)
                        ...
                        .css("margin-top", -(freezenTop + offTop - postil_top));
              ...
              if (c >= _this.freezenverticaldata[1]) {
                if (postil_left + postil_width < freezenLeft) {
                  $(e)
                    .show()
                    .find(".luckysheet-postil-show-main")
                    .css("left", postil_left + offLeft);
                  $(e)
                    .show()
                    .find(".arrowCanvas")
                    .css("left", size[0] + offLeft);
                } else {
                    ...
                    if (postil_left + postil_width <= freezenLeft + offLeft) {
                      ...
                      $(e)
                        ...
                        .css({
                          ...
                          width:
                            postil_width -
                            (freezenLeft + offLeft - postil_left),
                        });
                      $(e)
                        .show()
                        .find(".formulaInputFocus")
      ...
      scrollAdaptOfdpicon: function () {
        ...
        if (
          ...
          let offsetRow = luckysheet_searcharray(
            _this.freezenhorizontaldata[3],
            $("#luckysheet-cell-main").scrollTop() -
              _this.freezenhorizontaldata[2]
          );
          let freezen_colindex = _this.freezenverticaldata[1];
          let offsetColumn = luckysheet_searcharray(
            _this.freezenverticaldata[3],
            $("#luckysheet-cell-main").scrollLeft() -
              _this.freezenverticaldata[2]
          );
      ...
      scrollAdaptOffilteroptions: function () {
        ...
        if (
          ...
          $(
            ...
            let top =
              row_index - 1 == -1 ? 0 : Store.visibledatarow[row_index - 1];

            let col_index = $(e).data("cindex");

            if (
              row_index >= freezen_rowindex &&
              col_index >= freezen_colindex
            ) {
              if (
                top < freezen_top ||
              ...
              if (top < freezen_top) {
                ...
                let left =
                  Store.visibledatacolumn[col_index + offsetColumn] - 20;
              ...
              if (col_index < freezen_colindex + offsetColumn) {
                ...
                $(e)
                  .show()
                  .css("top", top + $("#luckysheet-cell-main").scrollTop());
              }
            } else {
...
export default window.__luckysheetFreezen;
