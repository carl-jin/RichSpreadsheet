...
function rightclickHTML() {
  return `<div id="luckysheet-rightclick-menu" class="luckysheet-cols-menu luckysheet-rightgclick-menu luckysheet-mousedown-cancel"></div>`;
  /*
  const _locale = locale();
        ...
        <div class="luckysheet-loading-content"> 
            <div class="${config.textClass} luckysheet-loading-text">
                <div class="ant-spin ant-spin-spinning" >
                    ...
                    <div class="ant-spin-text">努力加载中...</div>
                </div>
            </div>    
        </div>`;
