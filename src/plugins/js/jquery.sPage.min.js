    ...
    clickBtn: function () {
      ...
      this.element.on("click", "button", function () {
        ...
        switch (t) {
          ...
          case "after":
            s.page =
              Number(s.page) + Number(s.fastForward) <= n
                ? Number(s.page) + Number(s.fastForward)
                : n;
            t = s.page;
            break;
          case "go":
